...
(function() {
    ...
    document.write("<link rel='stylesheet' type='text/css' href='" + protocol + "//csdnimg.cn/pubfooter/css/pub_footer_1.0.3.css?v=201810123456'/>");
    ...
    var right_public_footer = '<div class="right_box footer_box csdn-tracking-statistics" data-mod="popu_475" data-dsm="post">\
        ...
        <div class="bg-gray">\
            ...
            <p class="fz12_baidu">©2018 CSDN版权所有 </p>\
            </div>\
        </div>\
    ...
    function changeImg(){
        var newItem
        if(storage.getItem('randomN') === '1'){
            newItem = '<div class="img-box"><a href="https://blog.csdn.net/csdnnews?utm_source=csdn_footer" target="_blank"><img style="padding:0;" src="//csdnimg.cn/pubfooter/images/csdn-zx.png" alt="官方公众号"></a><p class="app-text">官方公众号</p></div>\
                        <div class="img-box fr"><a href="https://blog.csdn.net/Blockchain_lemon?utm_source=csdn_footer" target="_blank"><img style="padding:0;" src="//csdnimg.cn/pubfooter/images/csdn-qkl.png" alt="区块链大本营"></a><p class="app-text">区块链大本营</p></div>'
            storage.setItem("randomN", '0');            
        }else if(storage.getItem('randomN') === '0'){
            newItem = '<div class="img-box"><a href="https://bbs.csdn.net/forums/Service?utm_source=csdn_footer" target="_blank"><img src="https://csdnimg.cn/pubfooter/images/csdn_cs_qr.png" alt="扫码联系客服"></a><p class="app-text">扫码联系客服</p>\</div>\
                        <div class="img-box fr" ><a href="https://www.csdn.net/app/?utm_source=csdn_footer" target="_blank"><img style="padding:6px" src="https://www.csdn.net/app/img/wxfix.png" alt="下载CSDN APP"></a><p class="app-text">下载CSDN APP</p>\</div>'
            storage.setItem("randomN", '1');
        }
        $(document).find('.contact-box').html(newItem)
    }
