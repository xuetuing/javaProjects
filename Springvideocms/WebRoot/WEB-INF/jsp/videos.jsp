...
<body>
	...
	<div class="main">
		...
		<div class="main_left">
			...
			<ul>
				<li data-src="userAdmin.do">管理员</li>
				<li data-src="roleList.do">角色管理</li>
				<li data-src="userVip.do">会员</li>
			</ul>
			<div class="li_title">产品管理<span class="down"></span></div>
			<ul>
				<li data-src="videosList.do">视频查看</li>
				<li data-src="videosUpload.do">视频上传</li>
			</ul>
